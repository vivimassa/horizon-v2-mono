  ...
  return (
    <div className="w-full max-w-2xl overflow-visible">
      <div className="relative overflow-visible" style={{ height: 64 }}>
        ...
        <div
          className="absolute top-1/2 -translate-y-1/2 left-4 right-4 rounded-lg"
          style={{
            height: 52,
        ...
        />
        <div
          className="absolute top-1/2 -translate-y-1/2 left-0 right-0 overflow-hidden rounded-[3px]"
          style={{
            height: 44,
        ...
        >
          ...
          <div
            ...
            style={{ background: 'linear-gradient(180deg, #2a2a2c, #1e1e20)', opacity: 0.3 }}
          />
          <div
            className="absolute inset-0 hidden dark:block"
            style={{ background: 'linear-gradient(180deg, #383838, #282828)', opacity: 0.3 }}
          />
          ...
          >
            ...
            <div
              className="absolute inset-0 hidden dark:block"
              style={{
                background: 'linear-gradient(180deg, #383838, #282828)',
          ...
          <svg viewBox={`0 0 ${W} ${H}`} className="absolute inset-0 w-full h-full" preserveAspectRatio="none">
            ...
            {[4, 12, 20].map((x) => (
              <polyline
                key={x}
                points={`${x},${H / 2 + 10} ${x + 8},${H / 2} ${x},${H / 2 - 10}`}
                fill="none"
                stroke="#d4a017"
                strokeWidth="1.5"
                strokeOpacity={mk((x / W) * 100)}
            ...
            {[38, 46].map((x) => (
              <g key={x} opacity={mk((x / W) * 100)}>
                ...
                <polyline
                  points={`${x + 3},${H / 2 - 3} ${x + 6},${H / 2} ${x + 3},${H / 2 + 3}`}
                  fill="none"
                  stroke="white"
                  strokeWidth="0.8"
                />
            ...
            {Array.from({ length: 8 }).map((_, i) => {
              const y = 4 + i * ((H - 8) / 8)
              return (
                <rect key={i} x={W - 70} y={y} width="14" height={(H - 8) / 8 - 1} fill="white" fillOpacity={mk(92)} />
              )
            })}
            ...
            {[W - 22, W - 14, W - 6].map((x) => (
              <polyline
                key={x}
                points={`${x + 8},${H / 2 + 10} ${x},${H / 2} ${x + 8},${H / 2 - 10}`}
                fill="none"
                stroke="#d4a017"
                strokeWidth="1.5"
                strokeOpacity={mk((x / W) * 100)}
          ...
          {/* ── YELLOW EDGE LIGHTS ── */}
          {['top', 'bottom'].map((edge) => (
            <div key={edge} className="absolute left-0 right-0 flex justify-between px-[2px]" style={{ [edge]: 2 }}>
      ...
      <style jsx>{`
        ...
        @keyframes grp-cl-g {
          0%,
          100% {
            background-color: rgba(80, 210, 70, 0.08);
            box-shadow: none;
          }
          50% {
            background-color: rgba(80, 210, 70, 0.95);
            box-shadow: 0 0 6px rgba(80, 210, 70, 0.7);
          }
        }
        @keyframes grp-cl-y {
          0%,
          ...
          50% {
            background-color: rgba(255, 200, 50, 0.95);
        ...
        @keyframes grp-cl-r {
          0%,
          100% {
            background-color: rgba(240, 50, 50, 0.08);
            box-shadow: none;
          }
          50% {
            background-color: rgba(240, 50, 50, 0.95);
            box-shadow: 0 0 6px rgba(240, 50, 50, 0.7);
          }
        }
        @keyframes grp-light-chase {
          ...
          50% {
            background-color: rgba(255, 210, 60, 1);
            box-shadow:
              0 0 8px rgba(255, 210, 60, 0.9),
              0 0 3px rgba(255, 210, 60, 1),
    ...
    <ProgressContext.Provider value={stableApi}>
      ...
      {phase === 'dismissing' && (
        <>
          ...
          <div
            className="fixed top-0 left-0 h-full z-[99998] bg-[#f0f2f5] dark:bg-[#111118]"
            style={{
              width: 'calc(50% + 40px)',
          ...
          <div
            className="fixed top-0 right-0 h-full z-[99998] bg-[#f0f2f5] dark:bg-[#111118]"
            style={{
              width: 'calc(50% + 40px)',
        ...
        >
          <div className="flex flex-col items-center w-full max-w-2xl overflow-visible">
            ...
            <div
              ...
              style={{
                width: 500,
                animation: phase === 'loading' ? 'grp-logo-breathe 3s ease-in-out infinite' : undefined,
              }}
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
