  ...
  return (
    <Tile palette={palette} isDark={isDark} blobColor="#7c3aed">
      <div className="flex items-center" style={{ marginBottom: 'clamp(12px, 1vw, 18px)' }}>
        ...
        <h2 style={{ fontSize: 'clamp(15px, 1.2vw, 20px)', fontWeight: 700, color: palette.text }}>
          Appearance & Display
        </h2>
      </div>
      ...
      <div className="flex gap-6">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              {isDark ? (
                <Moon size={15} style={{ color: accent }} strokeWidth={1.8} />
              ) : (
                <Sun size={15} style={{ color: accent }} strokeWidth={1.8} />
              )}
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <input
              ...
              onChange={(e) => {
                e.stopPropagation()
                setTextScale(TEXT_SCALE_OPTIONS[Number(e.target.value)].value)
              }}
