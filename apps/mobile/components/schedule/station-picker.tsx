    ...
    <Modal visible={visible} animationType="slide" transparent>
      <View className="flex-1" style={{ backgroundColor: 'rgba(0,0,0,0.4)' }}>
        <View className="flex-1 mt-20 rounded-t-2xl" style={{ backgroundColor: palette.background }}>
          ...
          <View
            className="flex-row items-center mx-4 mb-2 rounded-xl"
            style={{
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              ...
              >
                ...
                <Text style={{ fontSize: 14, color: palette.textTertiary, fontFamily: 'monospace', width: 36 }}>
                  {item.iataCode ?? ''}
                </Text>
