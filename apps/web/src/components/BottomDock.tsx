...
import { Home, Globe, Plane, TowerControl, Users, Settings, ChevronUp } from 'lucide-react'
  ...
  if (collapsed) {
    return (
      <button
        ...
        style={{
          background: isDark ? 'rgba(30,30,30,0.80)' : 'rgba(255,255,255,0.80)',
          ...
          return (
            ...
            >
              ...
              <span
                ...
                style={{
                  color: active ? (isDark ? '#f0f0f0' : '#111111') : isDark ? '#777777' : '#888888',
