    ...
    return (
      ...
      >
        ...
        <div className="flex items-center justify-between text-[11px]" style={{ color: palette.textTertiary }}>
          <span>
            {selectedFlight.std} — {selectedFlight.sta}
          </span>
          <span>
            {selectedFlight.aircraftType} &middot; {selectedFlight.tailNumber}
          </span>
        </div>
      </div>
    )
      ...
      {hasSelection && (
        <div className="flex items-center justify-between px-3 pt-2.5 pb-0">
          <span
            ...
            style={{ color: palette.textTertiary, letterSpacing: '0.5px' }}
          >
            Cargo Details
          </span>
          <button
          ...
          >
            ...
            {showDropdown ? (
              ...
              <span
                ...
                style={{ color: hasSelection ? palette.text : palette.textTertiary }}
              >
            ...
            {flights.map((f) => {
              ...
              return (
                <button
                  ...
                  style={{
                    background:
                      f.id === selectedId ? (isDark ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.03)') : 'transparent',
                ...
                >
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1 mt-0.5">
                      <span className="text-[10px]" style={{ color: palette.textSecondary }}>
                        {f.dep}
                      </span>
                      ...
                      <span className="text-[10px] ml-auto" style={{ color: palette.textTertiary }}>
                        {f.aircraftType}
                      </span>
                    </div>
                  </div>
        ...
        <div className="flex-1 overflow-y-auto px-3 pb-3">
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <div className="flex-1 flex items-center gap-1">
                ...
                <Plane
                  size={12}
                  strokeWidth={2}
                  style={{ color: 'rgba(255,255,255,0.6)', transform: 'rotate(45deg)' }}
                />
                <div
                  className="flex-1 h-px"
                  style={{
          ...
          <div className="grid grid-cols-2 gap-1.5 mb-2">
            {[
              {
                label: 'Total Load',
                value: `${totalCapacity > 0 ? Math.round((totalWeight / totalCapacity) * 100) : 0}%`,
                highlight: true,
              },
              ...
              >
                ...
                <div
                  ...
                  style={{ color: palette.textTertiary, letterSpacing: '0.3px' }}
                >
                  {kpi.label}
                </div>
              </div>
          ...
          <CargoDetails flight={selectedFlight} allHolds={allHolds} accent={accent} palette={palette} isDark={isDark} />
        </div>
      )}
      ...
      {!hasSelection && (
        <div className="flex-1 flex items-center justify-center px-3 pb-4">
          <div className="text-center">
            ...
            <p className="text-[12px] font-medium" style={{ color: palette.textSecondary }}>
              Select a flight
            </p>
            <p className="text-[10px] mt-0.5" style={{ color: palette.textTertiary }}>
              Use search or arrows above
            </p>
          </div>
        </div>
      )}
