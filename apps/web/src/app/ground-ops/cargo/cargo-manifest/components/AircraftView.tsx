...
export function AircraftView({
  ...
  const clamp = useCallback((x: number, y: number) => {
    ...
    const topMin = kpi
      ? kpi.getBoundingClientRect().bottom - cRect.top + 4
      : 0;
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-3 z-[5] flex flex-col justify-end" style={{ top: hasSelection ? 110 : 12, bottom: 12, width: 300, transition: "top 0.8s cubic-bezier(0.16, 1, 0.3, 1)" }}>
        {children}
      </div>
