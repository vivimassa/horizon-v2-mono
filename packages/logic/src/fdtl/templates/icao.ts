...
export const ICAO_RULES: RuleTemplate[] = [
  // ── REST ───────────────────────────────────────────────────────────────────
  {
    ...
    rule_code: 'MIN_REST_PRE_FDP',
    label: 'Minimum rest before FDP',
    value: '12:00',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
  ...
  },
  {
    category: 'rest',
    subcategory: 'minimum_rest',
    rule_code: 'MIN_REST_EXTENDED',
    label: 'Extended rest after long FDP',
    value: '14:00',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
  ...
  },
  {
    category: 'rest',
    subcategory: 'minimum_rest',
    rule_code: 'REDUCED_REST_MIN',
    label: 'Reduced rest minimum',
    value: '10:00',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
  ...
  },
  {
    category: 'rest',
    subcategory: 'minimum_rest',
    rule_code: 'REDUCED_REST_MAX_7D',
    label: 'Max reduced rest per 7 days',
    value: '2',
    value_type: 'integer',
    unit: 'times',
    source: 'government',
  ...
  },
  {
    category: 'rest',
    subcategory: 'minimum_rest',
    rule_code: 'RECOVERY_REST',
    label: 'Recovery rest after reduced rest',
    value: '14:00',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
  ...
  {
    category: 'rest',
    subcategory: 'split_duty',
    rule_code: 'SPLIT_MIN_BREAK',
    label: 'Min break for split duty',
    value: '3:00',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
  ...
  },
  {
    category: 'rest',
    subcategory: 'split_duty',
    rule_code: 'SPLIT_FACILITY_REQ',
    label: 'Rest facility required for split',
    value: 'true',
    value_type: 'boolean',
    unit: '',
    source: 'government',
  ...
  {
    category: 'rest',
    subcategory: 'weekly_time_free',
    rule_code: 'WEEKLY_TIME_FREE',
    label: 'Minimum time free per 168 hours',
    value: '36:00',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
  ...
  // ── CUMULATIVE ─────────────────────────────────────────────────────────────
  {
    ...
    label: 'Max block hours in 28 days',
    value: '100:00',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
  ...
  },
  {
    ...
    label: 'Max block hours in 365 days',
    value: '900:00',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
  ...
  },
  {
    ...
    rule_code: 'MAX_DH_7D',
    label: 'Max duty hours in 7 days',
    value: '60:00',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
  ...
  },
  {
    ...
    label: 'Max duty hours in 28 days',
    value: '190:00',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
  ...
  {
    category: 'duty',
    subcategory: 'days_off',
    rule_code: 'MIN_OFF_7D',
    label: 'Min days off per 7 days',
    value: '1',
    value_type: 'integer',
    unit: 'day',
    source: 'government',
  ...
  },
  {
    category: 'duty',
    subcategory: 'days_off',
    rule_code: 'MIN_OFF_28D',
    label: 'Min days off per 28 days',
    value: '8',
    value_type: 'integer',
    unit: 'days',
    source: 'government',
  ...
  },
  {
    category: 'duty',
    subcategory: 'days_off',
    rule_code: 'SINGLE_OFF_DURATION',
    label: 'Min single day off duration',
    value: '36:00',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
  ...
  },
  {
    ...
    rule_code: 'POS_COUNTS_AS_DUTY',
    label: 'Positioning counts as duty',
    value: 'true',
    value_type: 'boolean',
    unit: '',
    source: 'government',
  ...
  // Cruise time deductions: available rest time = block − taxi out − taxi in − climb − descent
  {
    ...
    label: 'Taxi-out deduction for cruise time',
    value: '0:10',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
  ...
  },
  {
    ...
    label: 'Taxi-in deduction for cruise time',
    value: '0:10',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
  ...
  },
  {
    ...
    label: 'Climb phase deduction for cruise time',
    value: '0:30',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
  ...
  },
  {
    ...
    label: 'Descent phase deduction for cruise time',
    value: '0:30',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
  ...
  // ── QUALIFICATION ──────────────────────────────────────────────────────────
  {
    ...
    subcategory: 'recency',
    rule_code: 'RECENCY_LANDINGS',
    label: 'Min landings for recency',
    value: '3',
    value_type: 'integer',
    unit: 'landings',
    source: 'government',
  ...
  },
  {
    category: 'qualification',
    subcategory: 'recency',
    rule_code: 'RECENCY_PERIOD',
    label: 'Recency period',
    value: '90',
    value_type: 'integer',
    unit: 'days',
    source: 'government',
  ...
  },
  {
    category: 'qualification',
    subcategory: 'recency',
    rule_code: 'NIGHT_RECENCY_LDGS',
    label: 'Night recency landings',
    value: '1',
    value_type: 'integer',
    unit: 'landing',
    source: 'government',
  ...
  },
  {
    category: 'qualification',
    subcategory: 'pairing',
    rule_code: 'NEW_CP_FO_RESTRICT',
    label: 'Restrict new CP + new FO',
    value: 'true',
    value_type: 'boolean',
    unit: '',
    source: 'company',
  ...
  },
  {
    category: 'qualification',
    subcategory: 'pairing',
    rule_code: 'NEW_CREW_THRESHOLD',
    label: 'New crew block hour threshold',
    value: '500',
    value_type: 'integer',
    unit: 'BH',
    source: 'company',
