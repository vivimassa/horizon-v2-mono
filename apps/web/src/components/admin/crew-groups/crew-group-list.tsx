                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-1.5">
                      <span className={`text-[13px] font-medium ${isSel ? 'font-semibold' : ''}`}>{g.name}</span>
                      {!g.isActive && (
                    ...
                    {g.description && (
                      <span className="text-[11px] text-hz-text-secondary truncate block">{g.description}</span>
                    )}
                  </div>
                  <span className="text-[10px] font-mono text-hz-text-tertiary shrink-0">#{i + 1}</span>
                </button>
              )
            })}
          </div>
