            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <CabinClassRow
                  ...
                  isDark={isDark}
                  onPress={() =>
                    router.push({ pathname: '/(tabs)/settings/cabin-class-detail' as any, params: { id: item._id } })
                  }
                />
              )}
            />
          ...
          <SectionList
            ...
            renderItem={({ item }) => (
              <ConfigRow
                ...
                isDark={isDark}
                onPress={() =>
                  router.push({ pathname: '/(tabs)/settings/lopa-config-detail' as any, params: { id: item._id } })
                }
              />
            )}
          />
    ...
    >
      <View className="flex-row items-center">
        ...
        <View className="flex-row items-center" style={{ gap: 6 }}>
          <Text style={{ fontSize: 13, fontFamily: 'monospace', color: palette.textTertiary }}>#{cc.sortOrder}</Text>
    ...
    >
      <View className="flex-1">
        <View className="flex-row items-center" style={{ gap: 6 }}>
          ...
          {config.isDefault && <Star size={12} color="#f59e0b" fill="#f59e0b" strokeWidth={1.5} />}
        </View>
