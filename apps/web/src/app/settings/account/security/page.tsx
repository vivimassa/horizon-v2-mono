      ...
      <div className="flex flex-1 overflow-hidden gap-4 px-4 pb-4">
        ...
        >
          ...
          <div className="flex items-center gap-3 px-5 pt-5 pb-3">
            ...
            <div>
              <h1 className="font-bold" style={{ fontSize: F.xl, color: palette.text }}>
                Security
              </h1>
          ...
          <div className="px-5 py-4">
            ...
            <div
              ...
              style={{
                ...
                border: `1px solid ${twoFactor ? accentTint('#16a34a', 0.2) : accentTint('#b45309', 0.15)}`,
              }}
            >
              ...
              <button
                onClick={async () => {
                  ...
                  setTwoFactor(next)
                  await userApi.updateSecurity({ twoFactorEnabled: next })
                  refetch()
                }}
              ...
              style={{
                backgroundColor: biometric
                  ...
                  : isDark
                    ...
                    : 'rgba(0,0,0,0.02)',
                border: `1px solid ${biometric ? accentTint(ACCENT, 0.2) : palette.border}`,
              }}
            >
              <div className="flex items-center gap-3">
                <ScanFace size={20} style={{ color: biometric ? ACCENT : palette.textSecondary }} strokeWidth={1.8} />
                <div>
                  <p className="font-semibold" style={{ fontSize: F.sm, color: palette.text }}>
              ...
              <button
                onClick={async () => {
                  ...
                  setBiometric(next)
                  await userApi.updateSecurity({ biometricEnabled: next })
                  refetch()
                }}
                className="relative rounded-full cursor-pointer transition-colors shrink-0"
                style={{
                  ...
                  <React.Fragment key={i}>
                    <div className="flex items-center py-3.5">
                      <div
                        ...
                        style={{
                          backgroundColor: accentTint(
                            session.current ? ACCENT : palette.textTertiary,
                            isDark ? 0.12 : 0.06,
                          ),
                        }}
                      >
                        <Icon
                          size={18}
                          style={{ color: session.current ? ACCENT : palette.textSecondary }}
                          strokeWidth={1.8}
                        />
                      </div>
                      ...
                      <div className="flex items-center gap-3 shrink-0">
                        <span style={{ fontSize: F.min, color: palette.textTertiary }}>{session.time}</span>
                        {!session.current && (
                          <button
                ...
                {MOCK_ACTIVITY.map((item, i) => {
                  ...
                  return (
                    <div key={i} className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-medium" style={{ fontSize: F.sm, color: palette.text }}>
                          {item.text}
                        </p>
...
function PasswordField({
  ...
  return (
    <div className="mb-3">
      <label className="block mb-1.5" style={{ fontSize: F.min, color: palette.textTertiary }}>
        {label}
      </label>
      ...
      {success && (
        <p
          ...
          style={{ fontSize: 12, color: isDark ? '#4ade80' : '#16a34a', marginTop: 4 }}
        >
...
function GlassCard({
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5 px-5 py-3.5" style={{ borderBottom: `1px solid ${palette.border}` }}>
        <div
