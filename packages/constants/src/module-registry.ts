...
export const MODULE_REGISTRY: ModuleEntry[] = [
  ...
  { code: '1.1.3', name: 'Slot Planning', description: 'Track airport slot allocations and IATA 80/20 utilization', icon: 'CalendarClock', route: '/network/schedule/slot-manager', parent_code: '1.1', module: 'network', level: 2 },
  ...
  { code: '1.1.5', name: 'Charter Manager', description: 'Manage ad-hoc and charter flight operations', icon: 'PlaneTakeoff', route: '/network/control/charter-manager', parent_code: '1.1', module: 'network', level: 2 },
  { code: '1.1.6', name: 'Schedule Messaging', description: 'Generate and process ASM and SSM messages for schedule distribution', icon: 'MessageSquareShare', route: '/network/control/schedule-messaging', parent_code: '1.1', module: 'network', level: 2 },
  ...
  { code: '5.1.1', name: 'Cargo Manifest', description: 'Aircraft loading and cargo manifest management', icon: 'Package', route: '/ground-ops/cargo/cargo-manifest', parent_code: '5.1', module: 'ground', level: 2 },
