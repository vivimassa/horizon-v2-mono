      ...
      <div className="flex gap-2 shrink-0 mb-4">
        {stats.map((s) => (
          ...
          >
            ...
            />
            <div style={{ fontSize: 18, fontWeight: 700, color: s.a ? accent : textPrimary, marginTop: 2 }}>{s.v}</div>
            <div
              style={{
                fontSize: 13,
                fontWeight: 600,
        ...
        >
          ...
          {HOLD_DATA.map((h) => (
            <div key={h.name} className="flex items-center gap-3 mb-3">
              <span style={{ fontSize: 14, fontWeight: 600, color: isDark ? '#ccc' : '#333', width: 80 }}>
                {h.name}
              </span>
              ...
              <span style={{ fontSize: 14, fontWeight: 700, color: accent, width: 40, textAlign: 'right' }}>
                {h.pct}%
              </span>
            </div>
          ))}
