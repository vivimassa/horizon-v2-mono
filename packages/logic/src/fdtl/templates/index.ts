...
export function applyOverrides(
  base: RuleTemplate[],
  overrides: Array<RuleOverride | RuleTemplate>,
): RuleTemplate[] {
  ...
  for (const override of overrides) {
    ...
    if (existing) {
      ...
      if (r.category && r.subcategory && r.label && r.value != null && r.value_type && r.unit != null && r.source && r.sort_order != null) {
  ...
  switch (frameworkCode) {
    ...
    case 'TC_CAR700':
      return TC_CAR700_AUGMENTED.length > 0
        ? TC_CAR700_AUGMENTED
        : [
            { crew_count: 3, facility_class: 'CLASS_1', max_fdp_minutes: 900,  display_value: '15:00', source: 'government', legal_reference: 'CAR 700.60' },
            { crew_count: 3, facility_class: 'CLASS_2', max_fdp_minutes: 840,  display_value: '14:00', source: 'government', legal_reference: 'CAR 700.60' },
            { crew_count: 4, facility_class: 'CLASS_1', max_fdp_minutes: 1080, display_value: '18:00', source: 'government', legal_reference: 'CAR 700.60' },
            { crew_count: 4, facility_class: 'CLASS_2', max_fdp_minutes: 990,  display_value: '16:30', source: 'government', legal_reference: 'CAR 700.60' },
          ]

    case 'CAAS_ANR121':
      return [
        { crew_count: 3, facility_class: 'CLASS_1', max_fdp_minutes: 900,  display_value: '15:00', source: 'government', legal_reference: 'ANR-121 Fifth Schedule' },
        { crew_count: 4, facility_class: 'CLASS_1', max_fdp_minutes: 1080, display_value: '18:00', source: 'government', legal_reference: 'ANR-121 Fifth Schedule' },
      ]
