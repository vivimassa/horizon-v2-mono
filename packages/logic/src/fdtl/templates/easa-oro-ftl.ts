...
export const EASA_OVERRIDES: Array<RuleOverride | RuleTemplate> = [
...

  {
    ...
    rule_code: 'MAX_DH_14D',
    label: 'Max duty hours in 14 days',
    value: '110:00',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
    legal_reference: 'ORO.FTL.210(a)',
    sort_order: 5,
  },
]
...
export const EASA_SPECIFIC: RuleTemplate[] = [
  // ── ACCLIMATIZATION ────────────────────────────────────────────────────────
  {
    ...
    subcategory: 'state',
    rule_code: 'ACCLIM_PERIOD',
    label: 'Time to become acclimatized',
    value: '48:00',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
    legal_reference: 'CS FTL.1.205',
    sort_order: 1,
  },
  {
    category: 'acclimatization',
    subcategory: 'state',
    rule_code: 'ACCLIM_TZ_THRESHOLD',
    label: 'Time zone difference threshold',
    value: '2',
    value_type: 'integer',
    unit: 'hrs',
    source: 'government',
  ...
  },
  {
    category: 'acclimatization',
    subcategory: 'state',
    rule_code: 'UNKNOWN_STATE_FDP_RED',
    label: 'FDP reduction in unknown state',
    value: '2:00',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
  ...
  // ── DISRUPTIVE SCHEDULES ───────────────────────────────────────────────────
  {
    category: 'disruptive',
    subcategory: 'windows',
    rule_code: 'EARLY_START_WINDOW',
    label: 'Early start window',
    value: '05:00-06:59',
    value_type: 'text',
    unit: 'local',
    source: 'government',
  ...
  },
  {
    category: 'disruptive',
    subcategory: 'windows',
    rule_code: 'LATE_FINISH_WINDOW',
    label: 'Late finish window',
    value: '23:00-01:59',
    value_type: 'text',
    unit: 'local',
    source: 'government',
  ...
  },
  {
    category: 'disruptive',
    subcategory: 'windows',
    rule_code: 'NIGHT_DUTY_WINDOW',
    label: 'Night duty encroachment window',
    value: '02:00-04:59',
    value_type: 'text',
    unit: 'local',
    source: 'government',
  ...
  },
  {
    category: 'disruptive',
    subcategory: 'limits',
    rule_code: 'MAX_CONSEC_DISRUPTIVE',
    label: 'Max consecutive disruptive duties',
    value: '4',
    value_type: 'integer',
    unit: 'duties',
    source: 'company',
  ...
  },
  {
    ...
    rule_code: 'DISRUPTIVE_RECOVERY',
    label: 'Recovery after disruptive block',
    value: '36:00',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
  ...
  // ── EXTENSION — commander discretion ──────────────────────────────────────
  {
    ...
    rule_code: 'CMD_DISCRETION_UNAUG',
    label: 'Commander discretion (unaugmented)',
    value: '2:00',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
    legal_reference: 'ORO.FTL.205(f)',
    sort_order: 1,
  },
  {
    category: 'extension',
    subcategory: 'discretion',
    rule_code: 'CMD_DISCRETION_AUG',
    label: 'Commander discretion (augmented)',
    value: '3:00',
    value_type: 'duration',
    unit: 'hrs',
    source: 'government',
  ...
  },
  {
    ...
    rule_code: 'DISCRETION_REPORT_TO',
    label: 'Report discretion use to authority within',
    value: '28',
    value_type: 'integer',
    unit: 'days',
    source: 'government',
