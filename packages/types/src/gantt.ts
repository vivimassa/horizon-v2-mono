// Gantt — shared types for Schedule Gantt Chart (module 1.1.2).
// Used by web (apps/web/src/components/network/gantt/*) and mobile
// (apps/mobile/src/components/gantt/*). Single source of truth.
