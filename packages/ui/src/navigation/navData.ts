    ...
    sections: [
      ...
      },
      {
        ...
        pages: [
          ...
          { key: 'crew-positions', label: 'Crew Positions Database', num: '6.3.7', route: '/admin/crew-positions', iconName: 'UserRound', desc: 'Cockpit & cabin roles, rank order' },
          { key: 'expiry-codes', label: 'Expiry Codes Database', num: '6.3.8', route: '/admin/expiry-codes', iconName: 'FileCheck', desc: 'Qualification validity & formulas' },
        ],
      },
    ],
  },
