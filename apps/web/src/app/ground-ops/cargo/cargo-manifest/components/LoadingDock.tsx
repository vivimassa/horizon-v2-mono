...
export const LoadingDock = forwardRef<HTMLDivElement, LoadingDockProps>(function LoadingDock(
  { items, accent, isDark, position, onDragStart, isDragging },
  ref,
) {
    ...
    >
      ...
      <div className="flex items-center gap-1.5 mb-2">
        ...
        <span
          ...
          style={{ color: isDark ? '#a1a1aa' : '#6b7280', letterSpacing: '0.5px' }}
        >
          Loading Dock
        </span>
        <span
