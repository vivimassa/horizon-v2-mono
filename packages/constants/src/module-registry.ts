...
export const MODULE_REGISTRY: ModuleEntry[] = [
  ...
  },
  {
    ...
    icon: 'List',
    route: '/crew-ops/control/pairing/text',
    parent_code: '4.1.5',
    module: 'workforce',
    level: 3,
  },
  {
    ...
    icon: 'GanttChart',
    route: '/crew-ops/control/pairing/gantt',
    parent_code: '4.1.5',
    module: 'workforce',
    level: 3,
  },
  {
    ...
    icon: 'Sparkles',
    route: '/crew-ops/control/pairing/optimizer',
    parent_code: '4.1.5',
    module: 'workforce',
    level: 3,
  },
  {
    code: '4.1.5.4',
    name: 'Pairing Configurations',
    description: 'Operator-wide soft rules for pairing construction (ground times, cross-family, home base)',
    icon: 'Settings2',
    route: '/crew-ops/control/pairing/config',
    parent_code: '4.1.5',
    module: 'workforce',
    level: 3,
  },
  {
    ...
    description: 'Automatic crew assignment and interactive Gantt-based manual assignment',
    icon: 'CalendarDays',
    // Parent route points at the primary (Gantt) child so clicks on the
    // parent land on a useful page. Mirrors the 4.1.5 Crew Pairing pattern.
    route: '/crew-ops/control/crew-scheduling/gantt-chart',
    parent_code: '4.1',
    module: 'workforce',
    level: 2,
  },
  {
    ...
    description: 'Automatic crew assignment under FDTL constraints (coming soon)',
    icon: 'Sparkles',
    route: '/crew-ops/control/crew-scheduling/auto-roster',
    parent_code: '4.1.6',
    module: 'workforce',
    level: 3,
  },
  {
    code: '4.1.6.2',
    name: 'Crew Schedule — Gantt Chart',
    description: 'Interactive Gantt with drag-and-drop crew assignment + FDTL legality',
    icon: 'CalendarDays',
    route: '/crew-ops/control/crew-scheduling/gantt-chart',
    parent_code: '4.1.6',
    module: 'workforce',
