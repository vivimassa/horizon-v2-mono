...
export function LopaShell() {
  ...
  const handleSaveClass = useCallback(async (id: string, data: Partial<CabinClassRef>) => {
  ...
  const handleCreateClass = useCallback(async (data: Partial<CabinClassRef>) => {
  ...
  const handleSaveConfig = useCallback(async (id: string, data: Partial<LopaConfigRef>) => {
  ...
  const handleCreateConfig = useCallback(async (data: Partial<LopaConfigRef>) => {
