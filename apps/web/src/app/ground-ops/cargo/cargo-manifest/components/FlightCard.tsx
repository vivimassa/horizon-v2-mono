...
export function FlightCard({ flight, isSelected, onSelect, accent, palette, isDark }: FlightCardProps) {
  ...
  return (
      ...
      style={{
        ...
        background: isSelected
          ...
          : isDark
            ...
            : '#ffffff',
        border: `1.5px solid ${isSelected ? accent : isDark ? 'rgba(255,255,255,0.08)' : '#e5e7eb'}`,
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        <div className="flex-1 flex items-center gap-1">
          <div
            ...
            style={{
              background: isSelected ? 'rgba(255,255,255,0.25)' : isDark ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.1)',
      ...
      <div className="flex items-center justify-between mb-1.5">
        <span className="text-[11px]" style={{ color: isSelected ? 'rgba(255,255,255,0.7)' : palette.textSecondary }}>
      ...
      <div
        ...
        style={{
          background: isSelected ? 'rgba(255,255,255,0.15)' : isDark ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.06)',
        }}
      >
        <div
          ...
          style={{
            ...
            background: isSelected ? '#a7f3d0' : flight.loadPercent > 90 ? '#16a34a' : accent,
          }}
        />
      </div>
    </button>
