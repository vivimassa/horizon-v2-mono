...
import { getStatusStyle, CONTRACT_TYPE_LABELS, STATUS_TRANSITIONS, TRANSITION_VARIANT_COLORS } from './charter-types'
      ...
      <div className="flex items-center gap-3 min-w-0">
        {contract ? (
          <>
            ...
            {status && (
              <span
                className="shrink-0 px-2 py-0.5 rounded-md text-[13px] font-semibold capitalize"
                style={{
