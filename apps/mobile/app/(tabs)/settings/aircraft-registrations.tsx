          ...
          <SectionList
            ...
            renderItem={({ item }) => (
              <RegRow
                ...
                lopaLookup={lopaLookup}
                palette={palette}
                accent={accent}
                onPress={() =>
                  router.push({
                    pathname: '/(tabs)/settings/aircraft-registration-detail' as any,
                    params: { id: item._id },
                  })
                }
              />
...
const RegRow = memo(function RegRow({
  reg,
  typeLookup,
  lopaLookup,
  palette,
  ...
  reg: AircraftRegistrationRef
  typeLookup: Map<string, AircraftTypeRef>
  lopaLookup: Map<string, LopaConfigRef>
  palette: Palette
  accent: string
  onPress: () => void
}) {
