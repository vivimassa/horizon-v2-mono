...
export const NAV_TREE: NavModuleData[] = [
  ...
  // ── 2. Network ──
  {
    ...
    sections: [
      ...
      {
        key: 'partners-charter',
        label: 'Partners & Charter',
        num: '1.2',
        iconName: 'Handshake',
        pages: [
          {
            key: 'codeshare-manager',
            label: 'Codeshare Manager',
            num: '1.2.1',
            route: '/network/control/codeshare-manager',
            iconName: 'Link2',
            desc: 'Codeshare agreements & partner flight designators',
          },
          {
            key: 'charter-manager',
            ...
            desc: 'Charter & ad-hoc flight operations',
          },
        ],
      },
      {
        ...
        pages: [
          {
            ...
            desc: 'ASM/SSM inbound & outbound message management',
          },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        pages: [
          ...
          // 2.1.2 — Aircraft Maintenance
          {
            ...
            desc: 'Schedule and forecast maintenance events',
            group: 'Aircraft Maintenance',
            groupIconName: 'Wrench',
          },
          {
            key: 'maintenance-status-board',
            label: 'Status Board',
            num: '2.1.2.2',
            route: '/flight-ops/control/aircraft-maintenance/status-board',
            iconName: 'BarChart3',
            desc: 'Fleet maintenance health overview',
            group: 'Aircraft Maintenance',
            groupIconName: 'Wrench',
          },
          {
            ...
            desc: 'Tune SLAs, labels, rolling stops',
            group: 'Disruption Center',
            groupIconName: 'ShieldAlert',
          },
          {
          ...
          },
          {
            ...
            desc: 'Operations control centre overview',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        pages: [
          ...
          },
          {
            ...
            iconName: 'Plug',
            desc: 'Message automation & external system interfaces',
          },
        ],
      },
      {
