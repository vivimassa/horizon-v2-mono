...
export default function AircraftTypeDetailScreen() {
  ...
  const handleSave = useCallback(async () => {
    if (!acType || Object.keys(draft).length === 0) {
      setEditing(false)
      return
    }
    setSaving(true)
  ...
  const handleDelete = useCallback(() => {
    ...
    Alert.alert('Delete Aircraft Type', `Delete ${acType.icaoType} — ${acType.name}?`, [
      { text: 'Cancel', style: 'cancel' },
      {
        ...
        onPress: async () => {
          try {
            await api.deleteAircraftType(acType._id)
            router.back()
          } catch (err: any) {
            ...
            try {
              ...
              if (match) {
                msg = JSON.parse(match[2]).error || msg
              }
            } catch {}
      ...
      <SafeAreaView className="flex-1" style={{ backgroundColor: palette.background }} edges={['top']}>
        <View className="flex-1 justify-center items-center">
          <Text style={{ fontSize: 15, color: palette.textTertiary }}>
            {loading ? 'Loading...' : 'Aircraft type not found'}
          </Text>
        </View>
      </SafeAreaView>
    )
      ...
      <View className="px-4 pt-4 pb-4" style={{ borderBottomWidth: 1, borderBottomColor: palette.border }}>
        <View className="flex-row items-center justify-between">
          <View className="flex-row items-center flex-1 mr-2">
            ...
            >
              <Text style={{ fontSize: 14, fontWeight: '700', fontFamily: 'monospace', color: palette.text }}>
                {acType.icaoType}
              </Text>
            </View>
        ...
        {activeTab === 'basic' && (
          <>
            <View className={isTablet ? 'flex-row flex-wrap' : ''}>
              <Field
                label="ICAO Type"
                value={acType.icaoType}
                editing={editing}
                fieldKey="icaoType"
                editValue={get('icaoType')}
              ...
              <Field
                label="IATA Type"
                value={acType.iataType}
                editing={editing}
                fieldKey="iataType"
                editValue={get('iataType')}
                onChange={handleFieldChange}
                palette={palette}
                half={isTablet}
              />
              ...
              <Field
                label="Cockpit Crew"
                value={acType.cockpitCrewRequired}
                editing={editing}
                fieldKey="cockpitCrewRequired"
                editValue={get('cockpitCrewRequired')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
              ...
              <Field
                label="Cabin Crew"
                value={acType.cabinCrewRequired}
                editing={editing}
                fieldKey="cabinCrewRequired"
                editValue={get('cabinCrewRequired')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
              ...
              <PickerField
                ...
                editing={editing}
                fieldKey="category"
                editValue={CATEGORIES.find((c) => c.value === get('category'))?.label || get('category')}
                onChange={(k, v) => {
                  const cat = CATEGORIES.find((c) => c.label === v)
                  handleFieldChange(k, cat?.value || v)
                }}
                palette={palette}
                isDark={isDark}
                accent={accent}
        ...
        {activeTab === 'perf' && (
          <>
            ...
            <View className={isTablet ? 'flex-row flex-wrap' : ''}>
              <Field
                label="MTOW (kg)"
                value={acType.performance?.mtowKg}
                editing={editing}
                fieldKey="performance.mtowKg"
                editValue={get('performance.mtowKg')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
              ...
              <Field
                label="MLW (kg)"
                value={acType.performance?.mlwKg}
                editing={editing}
                fieldKey="performance.mlwKg"
                editValue={get('performance.mlwKg')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
              ...
              <Field
                label="MZFW (kg)"
                value={acType.performance?.mzfwKg}
                editing={editing}
                fieldKey="performance.mzfwKg"
                editValue={get('performance.mzfwKg')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
              ...
              <Field
                label="OEW (kg)"
                value={acType.performance?.oewKg}
                editing={editing}
                fieldKey="performance.oewKg"
                editValue={get('performance.oewKg')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
            ...
            <View className={isTablet ? 'flex-row flex-wrap' : ''}>
              <Field
                ...
                editing={editing}
                fieldKey="performance.maxFuelCapacityKg"
                editValue={get('performance.maxFuelCapacityKg')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
              ...
              <Field
                ...
                editValue={get('fuelBurnRateKgPerHour')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
            ...
            <View className={isTablet ? 'flex-row flex-wrap' : ''}>
              <Field
                ...
                editing={editing}
                fieldKey="performance.cruisingSpeedKts"
                editValue={get('performance.cruisingSpeedKts')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
              ...
              <Field
                ...
                editing={editing}
                fieldKey="performance.maxRangeNm"
                editValue={get('performance.maxRangeNm')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
              ...
              <Field
                label="Ceiling (FL)"
                value={acType.performance?.ceilingFl}
                editing={editing}
                fieldKey="performance.ceilingFl"
                editValue={get('performance.ceilingFl')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
            ...
            <View className={isTablet ? 'flex-row flex-wrap' : ''}>
              <ToggleField
                label="ETOPS Capable"
                value={acType.etopsCapable}
                editing={editing}
                fieldKey="etopsCapable"
                editValue={get('etopsCapable')}
                onChange={handleFieldChange}
                palette={palette}
                isDark={isDark}
                half={isTablet}
              ...
              <Field
                ...
                value={acType.etopsRatingMinutes}
                editing={editing}
                fieldKey="etopsRatingMinutes"
                editValue={get('etopsRatingMinutes')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
            ...
            <View className={isTablet ? 'flex-row flex-wrap' : ''}>
              <Field
                ...
                value={acType.noiseCategory}
                editing={editing}
                fieldKey="noiseCategory"
                editValue={get('noiseCategory')}
                onChange={handleFieldChange}
                palette={palette}
                half={isTablet}
              />
              <Field
                ...
                value={acType.emissionsCategory}
                editing={editing}
                fieldKey="emissionsCategory"
                editValue={get('emissionsCategory')}
                onChange={handleFieldChange}
                palette={palette}
                half={isTablet}
              />
            ...
            {lopaConfigs.length === 0 ? (
              ...
              lopaConfigs.map((lc) => (
                <View
                  ...
                  style={{ borderWidth: 1, borderColor: palette.cardBorder, padding: 12 }}
                >
                  ...
                  {lc.cabins.map((cabin, i) => {
                    ...
                    return (
                      <View key={i} className="flex-row items-center" style={{ gap: 8, paddingVertical: 4 }}>
                        ...
                        <Text style={{ fontSize: 13, fontWeight: '600', fontFamily: 'monospace', color: palette.text }}>
                          {cabin.seats}
                        </Text>
                      </View>
                    )
          ...
          <>
            <View className={isTablet ? 'flex-row flex-wrap' : ''}>
              <Field
                ...
                editing={editing}
                fieldKey="cargo.maxCargoWeightKg"
                editValue={get('cargo.maxCargoWeightKg')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
              ...
              <Field
                ...
                editing={editing}
                fieldKey="cargo.cargoPositions"
                editValue={get('cargo.cargoPositions')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
              ...
              <Field
                ...
                editing={editing}
                fieldKey="cargo.bulkHoldCapacityKg"
                editValue={get('cargo.bulkHoldCapacityKg')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
            ...
            <Field
              label="ULD Types"
              value={acType.cargo?.uldTypesAccepted?.join(', ')}
              editing={editing}
              fieldKey="cargo.uldTypesAccepted"
              editValue={get('cargo.uldTypesAccepted')?.join?.(', ') ?? get('cargo.uldTypesAccepted')}
              onChange={(k, v) =>
                handleFieldChange(
                  k,
                  typeof v === 'string'
        ...
        {activeTab === 'crew' && (
          <>
            ...
            <View className={isTablet ? 'flex-row flex-wrap' : ''}>
              <PickerField
                label="Class"
                value={acType.crewRest?.cockpitClass}
                options={REST_CLASSES}
                editing={editing}
                fieldKey="crewRest.cockpitClass"
                editValue={get('crewRest.cockpitClass')}
                onChange={handleFieldChange}
                palette={palette}
                isDark={isDark}
                accent={accent}
              ...
              <Field
                label="Positions"
                value={acType.crewRest?.cockpitPositions}
                editing={editing}
                fieldKey="crewRest.cockpitPositions"
                editValue={get('crewRest.cockpitPositions')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
            ...
            <View className={isTablet ? 'flex-row flex-wrap' : ''}>
              <PickerField
                label="Class"
                value={acType.crewRest?.cabinClass}
                options={REST_CLASSES}
                editing={editing}
                fieldKey="crewRest.cabinClass"
                editValue={get('crewRest.cabinClass')}
                onChange={handleFieldChange}
                palette={palette}
                isDark={isDark}
                accent={accent}
              ...
              <Field
                label="Positions"
                value={acType.crewRest?.cabinPositions}
                editing={editing}
                fieldKey="crewRest.cabinPositions"
                editValue={get('crewRest.cabinPositions')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
          ...
          <>
            ...
            <View className={isTablet ? 'flex-row flex-wrap' : ''}>
              <Field
                ...
                editing={editing}
                fieldKey="weather.minCeilingFt"
                editValue={get('weather.minCeilingFt')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
              ...
              <Field
                label="Min RVR (m)"
                value={acType.weather?.minRvrM}
                editing={editing}
                fieldKey="weather.minRvrM"
                editValue={get('weather.minRvrM')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
              ...
              <Field
                ...
                editing={editing}
                fieldKey="weather.minVisibilityM"
                editValue={get('weather.minVisibilityM')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
              ...
              <Field
                ...
                editing={editing}
                fieldKey="weather.maxCrosswindKt"
                editValue={get('weather.maxCrosswindKt')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
              ...
              <Field
                label="Max Wind (kt)"
                value={acType.weather?.maxWindKt}
                editing={editing}
                fieldKey="weather.maxWindKt"
                editValue={get('weather.maxWindKt')}
                onChange={handleFieldChange}
                palette={palette}
                numeric
                half={isTablet}
            ...
            <View className={isTablet ? 'flex-row flex-wrap' : ''}>
              <PickerField
                ...
                options={ILS_CATS}
                editing={editing}
                fieldKey="approach.ilsCategoryRequired"
                editValue={get('approach.ilsCategoryRequired')}
                onChange={handleFieldChange}
                palette={palette}
                isDark={isDark}
                accent={accent}
              ...
              />
              <ToggleField
                label="Autoland Capable"
                value={acType.approach?.autolandCapable ?? false}
                editing={editing}
                fieldKey="approach.autolandCapable"
                editValue={get('approach.autolandCapable')}
                onChange={handleFieldChange}
                palette={palette}
                isDark={isDark}
                half={isTablet}
