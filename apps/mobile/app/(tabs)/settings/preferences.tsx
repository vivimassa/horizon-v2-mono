    ...
    <>
      ...
      >
        <DropdownPicker
          ...
          onToggle={() => setExpandedPicker(expandedPicker === 'language' ? null : 'language')}
          palette={palette}
          isDark={isDark}
          fonts={fonts}
        />
        <DropdownPicker
          ...
          expanded={expandedPicker === 'timezone'}
          onToggle={() => setExpandedPicker(expandedPicker === 'timezone' ? null : 'timezone')}
          palette={palette}
          isDark={isDark}
          fonts={fonts}
        />
      ...
      >
        <DropdownPicker
          ...
          expanded={expandedPicker === 'dateFormat'}
          onToggle={() => setExpandedPicker(expandedPicker === 'dateFormat' ? null : 'dateFormat')}
          palette={palette}
          isDark={isDark}
          fonts={fonts}
        />
  ...
  return (
    <SafeAreaView className="flex-1" style={{ backgroundColor: palette.background }} edges={['top']}>
      ...
      <View className="flex-row items-center justify-between px-4 py-3">
        ...
        >
          {saved ? <Check size={14} color="#fff" strokeWidth={2.5} /> : <Save size={14} color="#fff" strokeWidth={2} />}
          <Text style={{ fontSize: fonts.xs, fontWeight: '600', color: '#fff' }}>{saved ? 'Saved' : 'Save'}</Text>
        </Pressable>
      </View>
...
function PreviewRow({
  ...
  return (
    <View className="flex-row items-center gap-2.5 mb-3">
      ...
      <Text className="flex-1 font-medium" style={{ fontSize: fonts.sm, color: palette.text }} numberOfLines={1}>
        {value}
      </Text>
    </View>
  )
    ...
    <View style={{ marginBottom: 14, borderBottomWidth: 0.5, borderBottomColor: palette.border, paddingBottom: 14 }}>
      ...
      <Pressable
        ...
        style={{
          ...
          borderWidth: 1,
          borderColor: expanded ? ACCENT : isDark ? 'rgba(255,255,255,0.12)' : 'rgba(0,0,0,0.1)',
        }}
      >
        ...
        {options.map((opt) => {
          ...
          return (
            ...
            >
              ...
              <Text style={{ fontSize: fonts.xs, color: palette.textSecondary, marginTop: 2 }}>{opt.example}</Text>
            </Pressable>
          )
        })}
      </View>
