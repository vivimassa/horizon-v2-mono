        ...
        >
          ...
          <RibbonSection label="Mapping">
            <RibbonBtn
              icon={Link2}
              label="Add"
              onClick={hasSelection ? onAddMapping : undefined}
              isDark={isDark}
              hoverBg={hoverBg}
              tooltip="Add mapping"
            />
            <RibbonBtn
              icon={Upload}
              label="Bulk"
              onClick={hasSelection ? onBulkImport : undefined}
              isDark={isDark}
              hoverBg={hoverBg}
              tooltip="Bulk import"
            />
          ...
          <RibbonSection label="Export">
            <RibbonBtn
              icon={Download}
              label="SSIM"
              onClick={hasSelection ? onExportSsim : undefined}
              isDark={isDark}
              hoverBg={hoverBg}
              tooltip="Export SSIM file"
            />
            <RibbonBtn
              icon={FileText}
              label="Copy"
              ...
              isDark={isDark}
              hoverBg={hoverBg}
              tooltip="Copy SSIM to clipboard"
            />
          </RibbonSection>
          <Divider isDark={isDark} />
  ...
  return (
    <Tooltip content={tooltip ?? label}>
      <button
        ...
        onMouseEnter={(e) => {
          if (!active && onClick) e.currentTarget.style.background = hoverBg
        }}
        onMouseLeave={(e) => {
