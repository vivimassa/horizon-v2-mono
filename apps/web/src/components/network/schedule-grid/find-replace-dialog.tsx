    ...
    >
      ...
      <div className="flex items-center justify-between px-4 pt-3.5 pb-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[15px] font-semibold text-hz-text">{showReplace ? 'Find & Replace' : 'Find'}</span>
        </div>
        <button
          onClick={onClose}
      ...
      <div className="px-4 pb-4 space-y-3">
        ...
        <div className="relative">
          ...
          {query && matches.length > 0 && (
            <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[11px] font-mono font-medium text-hz-text-tertiary">
