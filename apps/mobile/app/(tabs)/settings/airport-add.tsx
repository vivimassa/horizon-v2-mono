...
import { ChevronLeft, Globe, Loader2, AlertCircle, ChevronDown, Check } from 'lucide-react-native'
        ...
        {!manualMode ? (
          <>
                  ...
                  <View className="flex-1">
                    ...
                    <Pressable
                      onPress={() => {
                        setManualMode(true)
                        setNotFound(false)
                        setForm((p) => ({ ...p, icaoCode: lookupCode }))
                      }}
            ...
            {lookupResult && (
              ...
              >
                ...
                <Pressable
                  onPress={handleCreateFromLookup}
                  disabled={creating}
          ...
          <>
            ...
            <FormField
              ...
              palette={palette}
              mono
              onChange={(v) => setForm((p) => ({ ...p, icaoCode: v.toUpperCase() }))}
              maxLength={4}
            />
            <FormField
              label="IATA Code"
              ...
              palette={palette}
              mono
              onChange={(v) => setForm((p) => ({ ...p, iataCode: v.toUpperCase() }))}
              maxLength={3}
            />
            <FormField
              label="Airport Name *"
