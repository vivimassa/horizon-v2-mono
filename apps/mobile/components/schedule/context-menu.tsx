...
import { Copy, Scissors, ClipboardPaste, Plus, SeparatorHorizontal, Trash2 } from 'lucide-react-native'
...
function MenuItem({
  ...
  return (
    ...
    >
      <Icon
        size={16}
        color={destructive ? (isDark ? '#f87171' : '#dc2626') : palette.textSecondary}
        strokeWidth={1.8}
      />
      <Text
        style={{
          ...
          fontWeight: '500',
          flex: 1,
          color: destructive ? (isDark ? '#f87171' : '#dc2626') : palette.text,
        }}
      >
        {label}
      </Text>
