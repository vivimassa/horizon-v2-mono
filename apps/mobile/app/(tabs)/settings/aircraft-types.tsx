...
const AircraftIcon = domainIcons.aircraft
      ...
      <SafeAreaView className="flex-1" style={{ backgroundColor: palette.background }} edges={['top']}>
        <View style={{ borderBottomWidth: 1, borderBottomColor: palette.border, paddingBottom: 12, paddingTop: 4 }}>
          <ListScreenHeader
            ...
            countLabel="type"
            onAdd={() => router.push('/(tabs)/settings/aircraft-type-add' as any)}
          />
          <View style={{ paddingHorizontal: 16 }}>
            <SearchInput placeholder="Search ICAO, name, manufacturer..." value={search} onChangeText={setSearch} />
          </View>
        </View>
