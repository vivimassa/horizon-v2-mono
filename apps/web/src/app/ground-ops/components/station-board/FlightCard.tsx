    ...
    >
      ...
      <div className="flex items-center justify-between mb-1">
        <div className="flex items-center gap-1.5">
          ...
          <span style={{ fontSize: 13, color: isDark ? '#888' : '#999', fontFamily: 'monospace' }}>{flight.type}</span>
        </div>
        <span
      ...
      <div className="flex items-center gap-1 mb-1">
        ...
        <div className="flex-1 flex items-center">
          <div
            ...
            style={{ borderTop: `1px dashed ${isDark ? 'rgba(255,255,255,0.15)' : '#ccc'}` }}
          />
          <Plane
            size={10}
            strokeWidth={2}
            style={{ color: isDark ? '#666' : '#bbb', transform: 'rotate(45deg)', margin: '0 3px' }}
          />
          <div
            className="flex-1 h-0"
            style={{ borderTop: `1px dashed ${isDark ? 'rgba(255,255,255,0.15)' : '#ccc'}` }}
      ...
      <div className="flex items-center gap-1.5 mt-1.5">
        <div
          ...
          style={{ height: 3, borderRadius: 2, background: isDark ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.06)' }}
        >
          <div
            style={{
              height: '100%',
              width: `${ph.pct}%`,
              borderRadius: 2,
              background: ph.pct === 100 ? '#22c55e' : accent,
            }}
          />
        </div>
