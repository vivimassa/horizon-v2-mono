    ...
    >
      ...
      <div style={{ padding: '10px 12px 6px' }}>
        <div className="flex items-center justify-between mb-2">
          <span style={{ fontSize: 15, fontWeight: 700, color: isDark ? '#f5f5f5' : '#111' }}>Flights Today</span>
          <span style={{ fontSize: 13, color: isDark ? '#777' : '#999' }}>{flights.length} flights</span>
        </div>
        <div
