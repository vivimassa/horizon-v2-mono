...
import { ChevronLeft, Pencil, Save, X, Trash2, Plus, Star, Plane } from 'lucide-react-native'
...
export default function LopaConfigDetailScreen() {
  ...
  const handleDelete = useCallback(() => {
    if (!config) return
    Alert.alert('Delete Configuration', `Delete ${config.configName} (${config.aircraftType})?`, [
          ...
          <View className="flex-row items-center flex-1 mr-2">
            ...
            {config.isDefault && (
              <View
                ...
                style={{ backgroundColor: isDark ? 'rgba(245,158,11,0.15)' : '#fef3c7', gap: 3 }}
              >
                  ...
                  >
                    <View
                      style={{
                        ...
                        height: 14,
                        borderRadius: 7,
                        backgroundColor: getClassColor(cabin.classCode),
                      }}
                    />
                    <Text
                      style={{
