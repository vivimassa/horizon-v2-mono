...
export const MODULE_REGISTRY: ModuleEntry[] = [
  ...
  { code: '1.1.3', name: 'Slot Manager', description: 'Track airport slot allocations and IATA 80/20 utilization', icon: 'CalendarClock', route: '/network/schedule/slot-manager', parent_code: '1.1', module: 'network', level: 2 },
