...
import { View, Text, Pressable, ScrollView, Image, useWindowDimensions, Modal, Alert } from 'react-native'
            ...
            <View className="flex-row items-center">
              ...
              <View className="flex-1">
                ...
                <View className="flex-row items-center mt-0.5" style={{ gap: 4 }}>
                  ...
                  <Text style={{ fontSize: 13, color: palette.textSecondary }} numberOfLines={1}>
                    {userEmail}
                  </Text>
                </View>
                <View className="flex-row mt-1.5" style={{ gap: 6 }}>
                  ...
                  {isAdmin && (
                    ...
                    >
                      <Text style={{ fontSize: 11, fontWeight: '600', color: isDark ? '#60a5fa' : accent }}>
                        Administrator
                      </Text>
                    </View>
                  )}
          ...
          {isTablet ? (
            ...
            <View className="flex-row mt-4" style={{ gap: 10 }}>
              <BentoTile palette={palette} isDark={isDark} blobColor="#7c3aed">
                <IconCircle color="#7c3aed">
                  <PaletteIcon size={20} color="#7c3aed" strokeWidth={1.8} />
                </IconCircle>
              ...
              <BentoTile palette={palette} isDark={isDark} blobColor="#b45309">
                ...
                <IconCircle color="#b45309">
                  <Bell size={20} color="#b45309" strokeWidth={1.8} />
                </IconCircle>
              ...
              <BentoTile palette={palette} isDark={isDark} blobColor="#555">
                <IconCircle color="#555">
                  {isDark ? (
                    <Moon size={20} color="#555" strokeWidth={1.8} />
                  ) : (
                    <Sun size={20} color="#555" strokeWidth={1.8} />
                  )}
                </IconCircle>
            ...
            <View style={isTablet ? { flex: 1 } : undefined}>
              ...
              >
                ...
                <AccountItem
                  ...
                  subtitle="Password, biometrics, two-factor"
                ...
                <AccountItem
                  ...
                  iconColor="#0f766e"
                  title="Preferences"
                  subtitle="Language, timezone, date format, units"
                  palette={palette}
                  isDark={isDark}
              ...
              <View style={isTablet ? { flex: 1 } : { marginTop: 20 }}>
                ...
                <View style={{ gap: 10 }}>
                  <AdminCard
                    ...
                    subtitle="Airports, aircraft types, airlines, reference data"
                    palette={palette}
                    isDark={isDark}
                    onPress={() => router.push('/(tabs)/settings/master-database' as any)}
                  />
                  <AdminCard
                    icon={ShieldCheck}
                    iconColor="#7c3aed"
                    title="Users & Roles"
                    subtitle="User accounts, role assignment, RBAC permissions"
                    palette={palette}
                    isDark={isDark}
                  />
                  <AdminCard
                    ...
                    iconColor="#0f766e"
                    title="Interface"
                    subtitle="AMOS, SSIM, MVT integrations and message hub"
                    palette={palette}
                    isDark={isDark}
                  />
                  <AdminCard
                    ...
                    palette={palette}
                    isDark={isDark}
                    onPress={() => router.push('/(tabs)/settings/operator-config' as any)}
                  />
                </View>
              </View>
            )}
          ...
          >
            ...
            >
              ...
              <View
                ...
                style={{ width: 40, height: 4, borderRadius: 2, backgroundColor: isDark ? '#444' : '#ddd' }}
              />
    ...
    >
      <View
        ...
        style={{
          ...
          height: 40,
          borderRadius: 12,
          backgroundColor: accentTint(iconColor, isDark ? 0.12 : 0.06),
        }}
      >
