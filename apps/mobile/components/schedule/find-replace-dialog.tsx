    ...
    <View style={{
      ...
      <View className="flex-row items-center justify-between mb-3">
        ...
        <View className="flex-row items-center" style={{ gap: 6 }}>
          <Pressable onPress={() => setShowReplace(prev => !prev)} className="active:opacity-60">
            {showReplace ? <ChevronUp size={14} color={palette.textTertiary} /> : <ChevronDown size={14} color={palette.textTertiary} />}
          </Pressable>
      ...
      <View className="flex-row items-center mb-2" style={{ gap: 6 }}>
        <TextInput value={findText} onChangeText={setFindText}
          ...
          style={{
            flex: 1, fontSize: 14, color: palette.text, fontFamily: 'monospace',
      ...
      <View className="flex-row items-center" style={{ gap: 10 }}>
        ...
        <View style={{ flex: 1 }} />
        {matchCount > 0 && (
          <Text style={{ fontSize: 13, fontWeight: '600', color: accent }}>{currentMatch}/{matchCount}</Text>
        )}
