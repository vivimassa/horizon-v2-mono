...
export function ManifestItem({ item, accent, isDark }: ManifestItemProps) {
  const priorityConfig = {
    rush: { label: "Rush", bg: "#fef3c7", text: "#92400e", darkBg: "rgba(245,158,11,0.15)", darkText: "#fbbf24", icon: Zap },
    mail: { label: "Mail", bg: "#dbeafe", text: "#1e40af", darkBg: "rgba(30,64,175,0.15)", darkText: "#60a5fa", icon: Mail },
    normal: null,
  };
