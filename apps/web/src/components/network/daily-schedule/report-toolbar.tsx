    ...
    >
      ...
      <div className="flex items-center gap-3 mr-auto">
        ...
        <Stat
          ...
          color={stats.unassigned > 0 ? '#FF8800' : '#06C270'}
        />
        <Sep isDark={isDark} />
        <Stat
          icon={Clock}
          label="Block Hours"
          value={`${blockH}:${String(blockM).padStart(2, '0')}`}
      ...
      <button
        ...
        style={{
          background: compactMode ? 'var(--module-accent, #1e40af)' : btnBg,
          color: compactMode ? '#fff' : undefined,
          border: `1px solid ${compactMode ? 'transparent' : btnBorder}`,
        }}
              ...
              return (
                ...
                >
                  <span
                    ...
                    style={{
                      borderColor: visible ? accent : isDark ? 'rgba(255,255,255,0.20)' : 'rgba(0,0,0,0.20)',
