...
const CAPITAL_COORDS: Record<string, { lat: number; lng: number }> = {
  ...
  BY: { lat: 53.9006, lng: 27.559 }, // Minsk
  BE: { lat: 50.8503, lng: 4.3517 }, // Brussels
  BZ: { lat: 17.251, lng: -88.759 }, // Belmopan
  BJ: { lat: 6.4969, lng: 2.6289 }, // Porto-Novo
  BT: { lat: 27.4728, lng: 89.639 }, // Thimphu
  ...
  CM: { lat: 3.848, lng: 11.5021 }, // Yaoundé
  ...
  DM: { lat: 15.301, lng: -61.387 }, // Roseau
  ...
  ET: { lat: 9.025, lng: 38.7469 }, // Addis Ababa
  ...
  GM: { lat: 13.4549, lng: -16.579 }, // Banjul
  ...
  LU: { lat: 49.6116, lng: 6.13 }, // Luxembourg City
  ...
  NI: { lat: 12.115, lng: -86.2362 }, // Managua
  ...
  PW: { lat: 7.515, lng: 134.5825 }, // Ngerulmud
  ...
  LC: { lat: 14.0101, lng: -60.987 }, // Castries
  VC: { lat: 13.1579, lng: -61.2248 }, // Kingstown
  WS: { lat: -13.8333, lng: -171.75 }, // Apia
  ...
  SB: { lat: -9.4456, lng: 160.0 }, // Honiara
  ...
  SR: { lat: 5.852, lng: -55.2038 }, // Paramaribo
  ...
  TJ: { lat: 38.5598, lng: 68.774 }, // Dushanbe
...
async function main() {
  ...
  for (const country of countries) {
    ...
    if (coords) {
      await Country.updateOne({ _id: country._id }, { $set: { latitude: coords.lat, longitude: coords.lng } })
      updated++
    } else {
