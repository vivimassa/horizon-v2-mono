    ...
    <div className="flex-1 overflow-y-auto px-5 py-4">
      ...
      <div className="flex gap-2.5 mb-4">
        ...
        <SummaryCard
          ...
          value={summaryData.weeklySeats.toLocaleString()}
          isDark={isDark}
          palette={palette}
        />
          ...
          return (
            ...
            >
              ...
              {Object.keys(config).length > 0 && (
                <FuselageCapacityBar cabinConfig={config} allocations={allocMap} brandColor={null} isDark={isDark} />
              )}
              ...
              {isEditing && (
                <div className="mt-3 pt-3" style={{ borderTop: `1px solid ${glassBorder}` }}>
                  <div className="grid grid-cols-[60px_120px_80px_80px] gap-2 mb-2">
                    <div className="text-[13px] font-semibold uppercase" style={{ color: palette.textTertiary }}>
                      Cabin
                    </div>
                    <div className="text-[13px] font-semibold uppercase" style={{ color: palette.textTertiary }}>
                      Name
                    ...
                    <div key={cc.code} className="grid grid-cols-[60px_120px_80px_80px] gap-2 mb-1.5 items-center">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setEditAllocs((s) => ({
                            ...s,
                            [cc.code]: { ...s[cc.code], seats: parseInt(e.target.value) || 0 },
                          }))
                        }
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setEditAllocs((s) => ({
                            ...s,
                            [cc.code]: { ...s[cc.code], release: parseInt(e.target.value) || 72 },
                          }))
                        }
                        className="h-8 px-2 rounded-lg text-[13px] font-mono outline-none text-center"
                        style={{
            ...
            <table className="w-full">
              <thead>
                <tr>
                  ...
                  <th
                    className="text-[13px] font-semibold uppercase tracking-wider text-right px-2.5 py-2"
                    style={{ color: palette.textTertiary }}
                  >
                    Total
                  </th>
                  ...
                  <th
                    className="text-[13px] font-semibold uppercase tracking-wider text-left px-2.5 py-2 w-32"
                    style={{ color: palette.textTertiary }}
                  >
                    Utilization
                  </th>
                ...
                {mappings.map((m) => {
                  ...
                  return (
                    <tr key={m._id} style={{ borderBottom: `1px solid ${glassBorder}` }}>
                      ...
                      <td className="px-2.5 py-2 text-right font-mono text-[13px]" style={{ color: palette.text }}>
                        {total}
                      </td>
                      <td className="px-2.5 py-2 text-right font-mono text-[13px]" style={{ color: palette.text }}>
                        {partner}
                      ...
                      <td className="px-2.5 py-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[13px] font-semibold w-8 text-right" style={{ color: barColor }}>
                            {pct}%
                          </span>
                        </div>
                      </td>
...
function SummaryCard({
  ...
  return (
    ...
    >
      <div className="text-[20px] font-mono font-bold" style={{ color: palette.text }}>
        {value}
      </div>
