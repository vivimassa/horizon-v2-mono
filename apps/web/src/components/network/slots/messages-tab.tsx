      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              background: accentTint(MODULE_THEMES.network.accent, isDark ? 0.12 : 0.08),
              color: MODULE_THEMES.network.accent,
            }}
          >
              ...
              <button
                ...
                style={{
                  background: isSelected
                    ? accentTint(MODULE_THEMES.network.accent, isDark ? 0.12 : 0.08)
                    : 'transparent',
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[13px] mt-0.5" style={{ color: palette.textSecondary }}>
                    {date} {m.source ? `\u00b7 ${m.source}` : ''}{' '}
                    {m.parsedSeriesCount > 0 ? `\u00b7 ${m.parsedSeriesCount} series` : ''}
                  </div>
                </div>
              </button>
            )
