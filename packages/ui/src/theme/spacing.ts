...
export const buttonSize = {
  ...
  sm: { height: 24, fontSize: 11, paddingX: 8, radius: 8 },
  /** 32px — standard buttons, toolbar actions */
  md: { height: 32, fontSize: 12, paddingX: 12, radius: 8 },
...
export const badgeSize = {
  ...
  sm: { height: 20, fontSize: 11, paddingX: 6, radius: 6 },
  /** 24px — standard badges, status chips */
  md: { height: 24, fontSize: 12, paddingX: 8, radius: 6 },
