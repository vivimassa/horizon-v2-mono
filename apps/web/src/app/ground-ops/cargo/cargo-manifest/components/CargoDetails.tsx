    ...
    <div>
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-[9px]" style={{ color: palette.textTertiary }}>
            MAC
          </span>
        </div>
        <div className="relative">
          ...
          >
            <div
              ...
              style={{ left: '15%', width: '50%', background: isDark ? 'rgba(22,163,74,0.2)' : 'rgba(22,163,74,0.15)' }}
            />
            <div
      ...
      {holds.map((hold) => (
        <div key={hold.key} className="mb-2">
          ...
          <div
            ...
            style={{ background: isDark ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.06)' }}
          >
            <div className="h-full rounded-full" style={{ width: `${hold.percent}%`, background: accent }} />
          </div>
