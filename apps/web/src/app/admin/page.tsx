  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        icon: PlaneTakeoff,
        href: '/admin/aircraft-registrations',
      },
      {
        code: '5.2.3',
        label: 'Delay Codes',
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        icon: Activity,
        href: '/admin/activity-codes',
      },
      {
        code: '5.4.5',
        label: 'Crew Complements',
        desc: 'Min crew per aircraft type & augmentation',
        icon: UsersRound,
        href: '/admin/crew-complements',
      },
      {
        code: '5.4.6',
        label: 'Crew Groups',
  ...
  return (
    <section>
      ...
      {section.cards.length > 0 ? (
        ...
        >
          <PackageOpen size={20} strokeWidth={1.5} style={{ color: palette.textTertiary }} />
          <div>
            <p className="text-[13px] font-medium" style={{ color: palette.textSecondary }}>
              Coming soon
            </p>
