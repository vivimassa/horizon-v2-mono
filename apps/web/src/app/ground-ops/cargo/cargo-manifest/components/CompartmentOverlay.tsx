...
export const CompartmentOverlay = forwardRef<HTMLButtonElement, CompartmentOverlayProps>(function CompartmentOverlay(
  { zone, isActive, onSelect, accent },
  ref,
) {
  return (
    <button
      ...
      style={{
        ...
        boxShadow: isActive ? `0 0 30px ${accent}1f` : 'none',
        cursor: 'pointer',
