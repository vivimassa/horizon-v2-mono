...
export function GridContextMenu({
  ...
  const MenuItem = ({
    ...
    <button
      ...
      onMouseEnter={(ev) => {
        ev.currentTarget.style.background = destructive ? destructiveHover : hoverBg
    ...
    >
      ...
      {shortcut && (
        <span className="text-[11px] font-mono" style={{ color: secondaryText }}>
          {shortcut}
        </span>
      )}
    </button>
  ...
  const Divider = () => <div className="h-px my-1 mx-2" style={{ background: border }} />
    ...
    <div ref={menuRef} className="fixed z-[9999]" style={{ left: mx, top: my }}>
      <div
        ...
        style={{
          ...
          boxShadow: isDark ? '0 8px 32px rgba(0,0,0,0.15)' : '0 8px 32px rgba(0,0,0,0.5)',
        }}
      >
        {/* Row info */}
              ...
              >
                <span className="flex items-center gap-2">
                  <Circle
                    ...
                    style={{
                      fill: STATUS_OPTIONS.find((s) => s.value === currentStatus)?.color,
                      color: STATUS_OPTIONS.find((s) => s.value === currentStatus)?.color,
                    }}
                  />
                  Change Status
                </span>
                      ...
                      {STATUS_OPTIONS.map((opt) => (
                        ...
                        >
                          ...
                          {currentStatus === opt.value && (
                            <span className="text-[10px] font-mono ml-auto" style={{ color: secondaryText }}>
                              current
                            </span>
                          )}
                        </button>
