...
const SECTIONS: SectionDef[] = [
  {
    key: 'reporting',
    label: 'Reporting & Debrief Defaults',
    icon: Clock,
    fields: [
  ...
  {
    key: 'wocl',
    label: 'Window of Circadian Low (WOCL)',
    icon: Moon,
    fields: [
  ...
  {
    key: 'cabin',
    label: 'Cabin Crew Rules',
    icon: Radio,
    fields: [{ key: 'cabinCrewSeparateRules', label: 'Separate Cabin Crew Rules', type: 'toggle' }],
  },
]
      ...
      <SafeAreaView className="flex-1" style={{ backgroundColor: palette.background }} edges={['top']}>
        <View className="flex-1 justify-center items-center">
          <Text style={{ fontSize: 15, color: palette.textTertiary }}>
            {loading ? 'Loading...' : 'Scheme not found'}
          </Text>
        </View>
      </SafeAreaView>
    )
          ...
          return (
            ...
            >
              ...
              >
                ...
                <Text style={{ fontSize: 15, fontWeight: '600', color: palette.text, flex: 1, marginLeft: 10 }}>
                  {section.label}
                </Text>
                <ChevronDown
                  size={14}
                        ...
                        return (
                          <View
                            ...
                            style={{
                              ...
                              ...(isTablet ? { width: '50%', paddingRight: 12 } : {}),
                            }}
                          >
                            <Text
                              style={{ fontSize: 13, color: palette.textSecondary, fontWeight: '600', marginBottom: 4 }}
                            >
                              {field.label}
                            </Text>
                            <Pressable
                              onPress={() => handleChange(field.key, !current)}
                      ...
                      return (
                        ...
                        >
                          ...
                          <TextInput
                            ...
                            keyboardType={
                              field.type === 'hhmm' || field.type === 'time' ? 'numbers-and-punctuation' : 'default'
                            }
                            style={{
                              fontSize: 15,
                              fontWeight: '600',
                              ...
                              color: palette.text,
                              borderBottomWidth: 1,
                              borderBottomColor: accentTint(accent, 0.2),
                              paddingVertical: 4,
                            }}
                          />
                        </View>
