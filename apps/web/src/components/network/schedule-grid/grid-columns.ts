...
export const GRID_COLUMNS: GridColumn[] = [
  ...
  { key: 'depStation',      label: 'DEP',       width: '4%',   editable: true,  type: 'text',      align: 'center', mono: true, maxLength: 4 },
  { key: 'arrStation',      label: 'ARR',       width: '4%',   editable: true,  type: 'text',      align: 'center', mono: true, maxLength: 4 },
  { key: 'flightNumber',    label: 'FLIGHT',    width: '5%',   editable: true,  type: 'text',      align: 'center', mono: true, maxLength: 8 },
  ...
  { key: 'departureDayOffset', label: 'OFFSET',  width: '3.5%', editable: true,  type: 'text',      align: 'center', mono: true, maxLength: 1 },
