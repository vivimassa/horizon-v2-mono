...
export const MOCK_FLIGHTS: StationFlight[] = [
  {
    ...
    gate: 'A12',
    status: 'boarding',
    pax: { booked: 195, onboard: 142 },
    cargo: { loaded: 2840, capacity: 4200 },
    phase: 'loading',
    tat: 45,
    delays: [],
  },
  {
    ...
    gate: 'B03',
    status: 'scheduled',
    pax: { booked: 180, onboard: 0 },
    cargo: { loaded: 0, capacity: 3800 },
    phase: 'pre_load',
    tat: 40,
    delays: [],
  },
  {
    ...
    gate: 'C07',
    status: 'departed',
    pax: { booked: 195, onboard: 195 },
    cargo: { loaded: 3950, capacity: 4200 },
    phase: 'departed',
    tat: null,
    delays: [],
  },
  {
    ...
    gate: '\u2014',
    status: 'delayed',
    pax: { booked: 162, onboard: 0 },
    cargo: { loaded: 310, capacity: 3800 },
    phase: 'pre_load',
    tat: 40,
  ...
  },
  {
    ...
    gate: 'A08',
    status: 'scheduled',
    pax: { booked: 210, onboard: 0 },
    cargo: { loaded: 0, capacity: 4200 },
    phase: 'pre_load',
    tat: 45,
    delays: [],
  },
