...
export const FAA_P117_OVERRIDES: Array<RuleOverride | RuleTemplate> = [
  ...
  { category: 'rest', subcategory: 'minimum_rest', rule_code: 'REST_SLEEP_OPP',
    label: 'Sleep opportunity within rest', value: '8:00', value_type: 'duration', unit: 'hrs',
    source: 'government', legal_reference: '14 CFR 117.25(b)', sort_order: 6 },
  ...
  { category: 'cumulative', subcategory: 'fdp_hours', rule_code: 'MAX_FDP_168H',
    label: 'Max FDP hours in 168 hours', value: '60:00', value_type: 'duration', unit: 'hrs',
    source: 'government', legal_reference: '14 CFR 117.23(b)', sort_order: 7 },
  { category: 'cumulative', subcategory: 'fdp_hours', rule_code: 'MAX_FDP_672H',
    label: 'Max FDP hours in 672 hours', value: '190:00', value_type: 'duration', unit: 'hrs',
    source: 'government', legal_reference: '14 CFR 117.23(b)', sort_order: 8 },

  // EXTENSION
  { category: 'extension', subcategory: 'discretion', rule_code: 'UNFORESEEN_EXT_MAX',
    label: 'Max unforeseen extension', value: '2:00', value_type: 'duration', unit: 'hrs',
    source: 'government', legal_reference: '14 CFR 117.19', sort_order: 1 },
  { category: 'extension', subcategory: 'reporting', rule_code: 'EXT_REPORT_THRESHOLD',
    label: 'Report exceedance >30 min within', value: '10', value_type: 'integer', unit: 'days',
    source: 'government', legal_reference: '14 CFR 117.19(b)', sort_order: 2 },

  // STANDBY
  { category: 'standby', subcategory: 'reserve', rule_code: 'SHORT_CALL_RESERVE_MAX',
    label: 'Short-call reserve max availability', value: '14:00', value_type: 'duration', unit: 'hrs',
    source: 'government', legal_reference: '14 CFR 117.21', sort_order: 1 },
  { category: 'standby', subcategory: 'reserve', rule_code: 'AIRPORT_STANDBY_IN_FDP',
    label: 'Airport standby counts in FDP', value: 'true', value_type: 'boolean', unit: '',
    source: 'government', legal_reference: '14 CFR 117.21', sort_order: 2 },

  // FITNESS
  { category: 'fitness', subcategory: 'declaration', rule_code: 'FFD_DECLARATION_REQ',
    label: 'Fitness for duty self-declaration', value: 'true', value_type: 'boolean', unit: '',
    source: 'government', legal_reference: '14 CFR 117.5', sort_order: 1 },
  { category: 'fitness', subcategory: 'declaration', rule_code: 'FFD_FATIGUE_CALL',
    label: 'Fatigue call permitted without penalty', value: 'true', value_type: 'boolean', unit: '',
    source: 'government', legal_reference: '14 CFR 117.5', sort_order: 2 },
  { category: 'fitness', subcategory: 'tracking', rule_code: 'FFD_TRACKING_REQ',
    label: 'Operator must track fatigue reports', value: 'true', value_type: 'boolean', unit: '',
    source: 'government', legal_reference: '14 CFR 117.9', sort_order: 3 },
]
...
export const FAA_AUGMENTED: AugmentedTemplate[] = [
  // 3-pilot crew
  { crew_count: 3, facility_class: 'CLASS_1', max_fdp_minutes: 1020, display_value: '17:00', source: 'government', legal_reference: '14 CFR Part 117 Table C' },
  { crew_count: 3, facility_class: 'CLASS_2', max_fdp_minutes: 960,  display_value: '16:00', source: 'government', legal_reference: '14 CFR Part 117 Table C' },
  { crew_count: 3, facility_class: 'CLASS_3', max_fdp_minutes: 900,  display_value: '15:00', source: 'government', legal_reference: '14 CFR Part 117 Table C' },
  // 4-pilot crew
  { crew_count: 4, facility_class: 'CLASS_1', max_fdp_minutes: 1140, display_value: '19:00', source: 'government', legal_reference: '14 CFR Part 117 Table C' },
  { crew_count: 4, facility_class: 'CLASS_2', max_fdp_minutes: 1080, display_value: '18:00', source: 'government', legal_reference: '14 CFR Part 117 Table C' },
  { crew_count: 4, facility_class: 'CLASS_3', max_fdp_minutes: 1050, display_value: '17:30', source: 'government', legal_reference: '14 CFR Part 117 Table C' },
]
